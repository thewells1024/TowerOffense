...
public class AngelCharacter extends AbstractGameObject {
   ...
   public AngelCharacter(final GameSurface gameSurface, final Bitmap image, final int xPos, final int yPos) {
      // super(image, CHARACTER_ROW_COUNT, CHARACTER_COL_COUNT, xPos, yPos);
      super(image, CHARACTER_ROW_COUNT, CHARACTER_COL_COUNT, gameSurface.getWidth() / 2 - X_OFFSET, 0);
   ...
   public AngelCharacter(final int xPos, final int yPos) {
      super(xPos, yPos);
      movingVectorX = xPos;
      movingVectorY = yPos;
   }
...
//      }
   ...
   public void setMovingVector(final int movingVectorX, final int movingVectorY) {
      AngelCharacter.movingVectorX = movingVectorX;
      AngelCharacter.movingVectorY = movingVectorY;
   }
